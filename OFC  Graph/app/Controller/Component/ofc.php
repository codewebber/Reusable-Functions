...
class OfcComponent extends Object {
  ...
  private $ofc_x_legend = array('text'=>'Y Data','size'=>10,'color'=>'#ff0000');
 ...
 /* public function set_ofc_bg_colour($color) {
    $this->ofc_bg_colour = $color;
  ...
  public function setup() {    
    ...
    //$this->ofc->set_bg_colour($this->ofc_bg_colour);
