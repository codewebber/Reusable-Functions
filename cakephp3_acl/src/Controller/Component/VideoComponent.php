...
class VideoComponent extends Component {
    public $allowed_ext = array('mp4','webm','mkv','flv','vob','ogv','ogg','gif','gifv','avi','mov','qt','wmv','yuv','rm','rmvb','asf','amv','m4p','m4v','mpg','mp2','mpeg','mpe','mpv','m2v','svi','3gp','3g2','mxf','roq','nsv','f4v','f4p','f4a','f4b');
