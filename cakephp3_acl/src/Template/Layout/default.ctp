...
<body>
    <nav class="top-bar expanded" data-topbar>
        <ul class="title-area large-3 medium-4 columns">
            <li class="name">
                <h1><a href="">Bookmarker<!-- $this->fetch('title'); --> </a></h1>
            </li>
        </ul>
    ...
    <ul class="side-nav">
        ...
        <li><?php  echo $this->Html->link('List Bookmarks',array('controller' => 'Bookmarks','action' => 'index')); ?></li>
        <li><?php  echo $this->Html->link('New Bookmark', array('controller' => 'Bookmarks','action' => 'add')); ?></li>
