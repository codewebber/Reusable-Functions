...
class FileComponent extends Component {
    ...
    public $allowed_ext = array('jpg', 'jpeg', 'png', 'gif', 'bmp', 'swf',
    		'mp4','webm','mkv','flv','avi','mov','wmv','yuv','mpg','mp2','mpeg','3gp',
    		'mp3','wav', 'pdf', 'zip'
    );
    public $min_filesize = 100;
    ...
    */
    ...
    public function upload($source, $targetdir, $targetfile,$type_image =null) {  
