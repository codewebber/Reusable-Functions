				...
				MultiFile.addToList = function (slave, slave_count, files) {
					...
					$.each(files, function (i, file) {
						...
						label.find('img.MultiFile-preview').each(function(){
							...
							//alert((data.indexOf('text/html')));
							oFReader.onload = function (oFREvent) {
							var filename = $("span.MultiFile-label").eq(data).prop('title');
							var extension = filename.replace(/^.*\./, '');
							  ...
							  case 'pjpeg':
							  case 'tif': 
                              case'tiff': {	t.src = oFREvent.target.result;
											data++;	
							  ...
							  case 'x-excel': 
							  case 'x-ms-excel': 
							  case 'vnd.openxmlformats-officedocument.spreadsheetml.sheet': {   t.src = 'assets/images/xls-lg.png';
							                                                                    data++;	
																								break;
																							}
							 
							
							  case 'html': {t.src = 'assets/images/html.png';
											data++;	
											break;
										   }
							  case 'js': {t.src = 'assets/images/js.png';
											data++;	
											break;
										 }
							  case 'mp3': 
							  case 'mp4':
							  case 'wav':
							  case 'wma':{t.src = 'assets/images/video.jpg';
							              data++;	
										  break;
							             }
							  case 'zip': 
							  ...
							  case 'octet-stream':{t.src = 'assets/images/zip.png';
							              data++;	
										 
										  alert(data+", "+$('.left-height .wrapper').height());
										  break;
							             }
							  case 'odf':
							  case 'odt':
							  ...
							  case 'doc':
							  case 'docx':{t.src = 'assets/images/doc.png';
							              data++;	
										  break;
							             }
							  case 'pdf':{t.src = 'assets/images/pdf.png';
							              data++;	
										  break;
							             }
							  case 'txt': 
							  case 'rtf':
							  case 'text':
							  case 'plain':{t.src = 'assets/images/page1.png';
							              data++;
										  break;
							             }
							  default:
							  data++;
                               t.src = 'assets/images/page1.png';
                              }
							  // alert("aaaa"+data+", "+$('.left-height .wrapper').height());
                               
                                        var heightBalance = function(){
										$('.right-height .wrapper').height("");
										$('.left-height .wrapper').height("");
										if($(window).width()>991)
										{
										var commonHeight = Math.max($('.right-height').height(),$('.left-height').height());
										$('.right-height .wrapper').height(commonHeight-60);
										$('.left-height .wrapper').height(commonHeight-60);
										}
										}								
								heightBalance();	
								 e.stopPropogation();
